...
dir_save_data = "/n/holyscratch01/onnela_lab/Users/lraynal/mixture_mechanisms/mechanistic_network_models/2-PA_RA_TF_obs_contact_network/generate_ref_table/ref_table_"+str(num_nodes)+"nodes"+example_number
...
df_obs_sum_RABC = df_obs_sum_3[sel_sum_names]
