...
df_weights_ref_table = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/ref_table/df_weights_ref_table_size_"+str(num_sim)+example_number+".csv"))
df_params_ref_table = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/ref_table/df_params_ref_table_size_"+str(num_sim)+example_number+".csv"))
df_summaries_ref_table_init = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/ref_table/df_summaries_ref_table_size_"+str(num_sim)+example_number+".csv"))
...
###!!! We suggest running the selection algorithm on a cluster
...
#                                                 n_jobs=n_jobs)
# time2 = time.time()
# print("Time Obs 1 recursive: ", time2 - time1)
...
average_RMSE_perResponse_recursif_obs1 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_perResponse_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
average_RMSE_total_recursif_obs1 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_total_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
eliminated_features_recursif_obs1 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/eliminated_features_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
recursive_selected_summaries_obs1 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/recursive_selected_summaries_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
...
#                                                 n_jobs=n_jobs)
# time2 = time.time()
# print("Time Obs 2 recursive: ", time2 - time1)
...
average_RMSE_perResponse_recursif_obs2 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_perResponse_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
average_RMSE_total_recursif_obs2 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_total_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
eliminated_features_recursif_obs2 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/eliminated_features_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
recursive_selected_summaries_obs2 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/recursive_selected_summaries_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
...
# time2 = time.time()
# print("Time Obs 3 recursive: ", time2 - time1)
...
average_RMSE_perResponse_recursif_obs3 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_perResponse_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
average_RMSE_total_recursif_obs3 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/average_RMSE_total_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
eliminated_features_recursif_obs3 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/eliminated_features_recursif_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
recursive_selected_summaries_obs3 = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/recursive_selected_summaries_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
...
df_weights_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_unselected/df_weights_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_params_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_unselected/df_params_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_dist_acc_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_unselected/df_dist_acc_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
...
df_weights_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_naive/df_weights_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_params_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_naive/df_params_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_dist_acc_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_naive/df_dist_acc_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
...
obs_idx = 1
recursive_selected_summaries_obs = pickle.load(open(resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/rankings/recursive_selected_summaries_obs"+str(obs_idx)+"_"+pred_type+example_number+".p"), "rb"))
...
df_weights_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_recursive/df_weights_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_params_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_recursive/df_params_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
df_dist_acc_RABC_obs = pd.read_csv(filepath_or_buffer = resource_filename("mechanistic_net_abc", "data/3-PA_RA_TF_mixture/SMC_recursive/df_dist_acc_RABC_obs"+str(obs_idx)+"_"+sel_type+example_number+".csv"))
